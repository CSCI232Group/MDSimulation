...
/*@author Ian Hecker, Jake Yakawich, Michael Hewitt, Garret Hilton 
...
public class Particle
{
    ...
    {      
        double dt;
        if(vx > 0)          dt = (1 - radius - rx) / vx;        
        else if (vx < 0)    dt = (radius - rx) / vx;        
        else                dt = INFINITY;                        
        return dt;
    }
    ...
    {             
        double dt;
        if(vy > 0)          dt = (1 - radius - ry) / vy;        
        else if (vy < 0)    dt = (radius - ry) / vy;       
        else                dt = INFINITY;
        return dt;
    }
